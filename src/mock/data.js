...
export const projectsData = [
  {
    ...
    info: `I started this project to implement a dashbord that could display data with a chart. I found a library called ReCharts to help accomplish this goal, my project uses one of their examples as the chart display for this website.`,
    info2: '',
